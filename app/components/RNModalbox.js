...
export default class Example extends React.Component {
    ...
    render() {
        var BContent = <TouchableOpacity onPress={() => this.setState({isOpen: false})} style={[styles.btn, styles.btnModal]}>X</TouchableOpacity>;
        ...
        return (
            <View style={styles.wrapper}>
                ...
                <TouchableOpacity onPress={() => this.refs.modal3.open()} style={styles.btn}>
                    <Text>Position centered + backdrop + disable</Text>

                </TouchableOpacity>
                <TouchableOpacity onPress={() => this.refs.modal4.open()} style={styles.btn}>
                    <Text>Position bottom + backdrop + slider</Text>

                </TouchableOpacity>
                <TouchableOpacity onPress={() => this.setState({isOpen: true})} style={styles.btn}>
                    <Text> Backdrop + backdropContent</Text>

                </TouchableOpacity>
                <TouchableOpacity onPress={() => this.refs.modal6.open()} style={styles.btn}>
                ...
                <Modal
                    ...
                    <TouchableOpacity onPress={() => this.setState({swipeToClose: !this.state.swipeToClose})} style={styles.btn}>Disable swipeToClose({this.state.swipeToClose ? "true" : "false"})</TouchableOpacity>
                </Modal>
                ...
                <Modal style={[styles.modal, styles.modal3]} position={"center"} ref={"modal3"} isDisabled={this.state.isDisabled}>
                    ...
                    <TouchableOpacity onPress={() => this.setState({isDisabled: !this.state.isDisabled})} style={styles.btn}>Disable ({this.state.isDisabled ? "true" : "false"})</TouchableOpacity>
                </Modal>
